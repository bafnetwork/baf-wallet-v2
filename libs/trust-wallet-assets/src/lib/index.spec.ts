  ...
  it('retrieves correct values for ethereum', 
    () => getChainInfo('ethereum')
        .then(info => {
            ...
            expect(info.white_paper).toBe("https://github.com/ethereum/wiki/wiki/White-Paper");
            expect(info.description).toBe("Open source platform to write and distribute decentralized applications.");
