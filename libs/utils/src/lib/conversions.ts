import { Converter, SecretKey, PublicKey, Encoding, KeyPair } from '@baf-wallet/interfaces';
...
function keyPairFromBaf<Curve>(bafKeyPair: KeyPair<Curve>): Pair<Buffer, Buffer> {
...
function keyPairToBaf<Curve>(keyPair: Pair<Buffer, Buffer>, curveMarker: Curve): KeyPair<Curve> {
