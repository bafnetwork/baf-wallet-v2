...
<div bind:this={overlay} on:click={handleClick} class={`z-40 absolute top-0 left-0 w-screen h-screen bg-gray-900 bg-opacity-50 ${visibilityClasses}`}>
    <div bind:this={container} class={`z-40 container flex flex-col items-center justify-center h-full m-auto ${visibilityClasses}`}>
